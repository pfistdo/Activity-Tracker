...
const port = process.env.SERVER_PORT || "5001"; // Use the PORT variable if set (e.g., when deploying to Heroku)
app.set("port", port);
...
// Create URI
const uri = "mongodb+srv://" + db_user + ":" + db_pw + "@cluster0.epapy.mongodb.net/?retryWrites=true&w=majority";
